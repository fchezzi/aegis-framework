...
function analisarComMediana($test_url, $strategy, $api_key, $num_tests) {
    ...
    echo "  Executando $num_tests testes para calcular mediana...\n";
    ...
    // Substituir score pela mediana calculada
    ...
    echo "  📊 Score mediana: " . round(calcularMediana($scores_performance)) . "\n";
