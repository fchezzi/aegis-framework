...
<head>
	...
	?>
	<title>Nova Página - <?= ADMIN_NAME ?></title>
</head>
...
<body class="m-pagebasebody">
  ...
  <main class="m-pagebase">
    ...
    <div class="m-pagebase__form-container">
      <form method="POST" action="<?= url('/admin/pages') ?>" class="m-pagebase__form" enctype="multipart/form-data">
        ...
        <div class="m-pagebase__form-group">
          ...
          >
          <div class="m-pagebase__form-help">O slug será gerado automaticamente. Ex: "Sobre Nós" → /sobre-nos</div>
          <?php
          // Mostrar slugs reservados
          $reservedSlugs = ['admin', 'login', 'logout', 'home', 'api', 'setup'];
          ...
          ?>
          <div class="m-pagebase__form-help m-pagebase__warning">
            Evite títulos que gerem os seguintes slugs reservados: <?= implode(', ', $reservedSlugs) ?>
          </div>
        </div>
        ...
        <div class="m-pagebase__seo-widget">
          ...
          <div class="m-pagebase__form-group">
            ...
            <select id="seo_robots" name="seo_robots" class="m-pagebase__form-select">
              <option value="index,follow">Index, Follow (Padrão - indexar e seguir links)</option>
              <option value="noindex,follow">NoIndex, Follow (Não indexar, mas seguir links)</option>
              <option value="noindex,nofollow">NoIndex, NoFollow (Não indexar nem seguir links)</option>
            </select>
          ...
          <div class="m-pagebase__form-group">
            ...
            <select id="seo_og_type" name="seo_og_type" class="m-pagebase__form-select">
              <option value="website">Website (Padrão)</option>
              <option value="article">Article (Artigo/Blog)</option>
            </select>
          </div>
          ...
          <div class="m-pagebase__form-group">
            ...
            <select id="seo_twitter_card" name="seo_twitter_card" class="m-pagebase__form-select">
              <option value="summary">Summary (Padrão - card pequeno)</option>
              <option value="summary_large_image">Summary Large Image (Card com imagem grande)</option>
            </select>
          </div>
        ...
        <div class="m-pagebase__form-group">
          ...
          <select id="type" name="type" required class="m-pagebase__form-select">
            <option value="custom">Custom (Específica do projeto)</option>
            <option value="core">Core (Padrão do AEGIS)</option>
          </select>
        ...
        <div class="m-pagebase__form-group">
          ...
          <select id="scope" name="scope" required class="m-pagebase__form-select">
            <option value="frontend">Frontend (Páginas públicas do site)</option>
            <option value="members">Members (Área de membros)</option>
            <option value="admin">Admin (Páginas administrativas)</option>
          </select>
        ...
        <div class="m-pagebase__form-group">
          <label for="template" class="m-pagebase__form-label">Template *</label>
          <select id="template" name="template" required class="m-pagebase__form-select">
          ...
          <div class="m-pagebase__form-help">Escolha o layout da página. Você pode editar o arquivo depois.</div>
        </div>
        ...
        <div class="m-pagebase__form-actions">
          <button type="submit" class="m-pagebase__btn m-pagebase__btn--widthauto">
            <i data-lucide="plus"></i> Criar Página
          </button>
  ...
  <script>
    ...
    (function() {
      ...
      function calculateScore() {
        ...
        // OG Image (5 pontos)
        if (document.getElementById('seo_og_image').value) {
          score += 5;
        }
