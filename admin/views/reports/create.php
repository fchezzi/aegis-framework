...
<head>
	...
	?>
	<title>Novo Template - Relatórios</title>
</head>
...
<body class="m-reportsbody">
	...
	<main class="m-pagebase">
		...
		<div class="m-pagebase__header">
			<h1>Novo Template de Relatório</h1>
		...
		<form method="POST" action="<?= url('/admin/reports/store') ?>" enctype="multipart/form-data" class="m-pagebase__form">
			<input type="hidden" name="csrf_token" value="<?= Security::generateCSRF() ?>">

			<div class="m-pagebase__form-group">
				<label class="m-pagebase__form-label">Nome do Relatório *</label>
				<input type="text" name="name" class="m-pagebase__form-input" required placeholder="Ex: Relatório YouTube - Janeiro 2026">
			</div>

			<div class="m-pagebase__form-group">
				<label class="m-pagebase__form-label">Descrição</label>
				<textarea name="description" class="m-pagebase__form-textarea" placeholder="Descrição opcional do relatório"></textarea>
			</div>

			<div class="m-pagebase__form-group">
				<label class="m-pagebase__form-label">Arquivo Excel (.xlsx ou .xls) *</label>
				<input type="file" name="excel_file" class="m-pagebase__form-input" accept=".xlsx,.xls" required>
				<div class="m-pagebase__form-help">Upload do template Excel formatado. Este arquivo será preenchido com dados do banco.</div>
			</div>
			...
			<div class="m-reports__cell-mapping">
				...
				<div id="cell-mappings">
					<div class="m-reports__cell-row">
						<div>
							<input type="text" name="cells[]" placeholder="Ex: B5" pattern="[A-Z]{1,3}[0-9]{1,7}" title="Ex: A1, B5, AA100">
							<small>Célula</small>
						</div>
						<div style="flex: 1;">
			...
			<div class="m-pagebase__form-actions">
				<button type="submit" class="m-pagebase__btn m-pagebase__btn--widthauto">
					<i data-lucide="save"></i> Criar Template
				</button>
